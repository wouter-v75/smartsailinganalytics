...
// sits at Sailor Silver for everything except the things they exist to do).
//
//   BUILD  — Sailor Gold and up: cutting a stretch of the day into phases is
//            analysis, it stays on the device, and nothing done here reaches
//            anybody else.
...
export const BUILD_PHASE_ROLES = ['admin', 'team_manager', 'coach', 'tl3'] as const
...
export function phaseRoleNote(role?: string | null): string | null {
  ...
  return 'Building phases is for Sailor Gold and up.'
}
