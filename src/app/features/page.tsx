    ...
    <Shell>
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <Card title="Forecast decks and venue model">
          ...
          <Card title="The plan and the timings">
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <Card title="Instrument logs" badge="Instrumented">
          ...
          <Card title="GPS trackers" badge="Tracker-only">
          ...
          <Card title="Video from anything">
          ...
          <Card title="Photos and sail shape">
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <Card title="The debrief, recorded">
          ...
          <Card title="Phase and manoeuvre analysis">
          ...
          <Card title="Shared with the whole team">
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Card title="Provenance on every number">
      ...
      <section className="py-14">
        <h2 className="text-[20px] font-bold tracking-tight sm:text-[24px]">Does it work with what we have?</h2>
