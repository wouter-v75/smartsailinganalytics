...
const FIELD_LABEL: Partial<Record<LogField, string>> = {
  ...
  dstLine: 'Distance to line', tmLine: 'BurnLine (Burn)',
  ttbPin: 'BurnPin (BurnToPin)', ttbCB: 'BurnBoat (BurnToCb)',
  ttbPort: 'Burn port end (StBsToP)', ttbStbd: 'Burn stbd end (StBsToS)', ttbOnStb: 'TTB on stbd',
